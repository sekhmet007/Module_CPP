...
void PmergeMe::sortVec(int argc, char **argv)//methode FD vector
{
...
static void printList(std::list<unsigned int> &lst)//print list
{
...
static std::list<unsigned int> mergeLists(std::list<unsigned int> &left, std::list<unsigned int> &right)//methode FD list
{
...
static std::list<unsigned int> mergeInsertList(std::list<unsigned int>& lst)//methode FD list
{
